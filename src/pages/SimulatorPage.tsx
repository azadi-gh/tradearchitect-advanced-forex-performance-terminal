...
import { runMonteCarlo, type SimParams, type SimResult } from '@/lib/sim-engine';
...
export function SimulatorPage() {
  ...
  const chartData = results.median.map((_, i) => ({
    trade: i,
            ...
            <Card className="h-[450px]">
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xl font-black">{formatCurrency(results.median[results.median.length - 1])}</div>
                </div>
              </CardHeader>
              ...
              <Card className="border-emerald-200 bg-emerald-50/50 dark:bg-emerald-950/10">
                ...
                <CardContent>
                  <div className="text-3xl font-black text-emerald-600">
                    {(((results.median[results.median.length - 1] - params.startBalance) / params.startBalance) * 100).toFixed(1)}%
                  </div>
